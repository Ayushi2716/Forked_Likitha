...
public class ExcelUtils {
	...
	/**
	 * get last column count
	 * @param sheetName
	 * @return
	 * @throws EncryptedDocumentException
	 * @throws IOException
	 */
	public int getColumnCount(String sheetName) throws EncryptedDocumentException, IOException {
		FileInputStream fi = new FileInputStream(IPathConstants.excelPath);
		Workbook wb = WorkbookFactory.create(fi);
		Sheet sh = wb.getSheet(sheetName);
	...
	/**
	 * Write/insert/add data to the excel file
	 * @param sheetName
	 * @param value
	 * @throws EncryptedDocumentException
	 * @throws IOException
	...
	public Object[][] ExcelMultipleDataUsingDataDriver(String sheetName) throws EncryptedDocumentException, IOException {
